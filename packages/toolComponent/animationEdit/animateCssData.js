const animateCssClassName = [
  {
    ...
    children: [
      ...
      { label: '左长距进入', value: 'fadeInLeftBig' },
      { label: '右长距进入', value: 'fadeInRightBig' },
      ...
      { label: '左弹入', value: 'bounceInLeft' },
      { label: '右弹入', value: 'bounceInRight' },
      { label: '上弹入', value: 'bounceInUp' },
      { label: '下弹入', value: 'bounceInDown' },
      ...
      { label: '上变大进入', value: 'zoomInUp' },
      { label: '下变大进入', value: 'zoomInDown' },
      { label: '左滑动展开', value: 'slideInLeft' },
      { label: '右滑动展开', value: 'slideInRight' },
      { label: '上滑动展开', value: 'slideInUp' },
      { label: '下滑动展开', value: 'slideInDown' },
      { label: '无', value: '' }
    ]
  },
  {
